...
jQuery(function ($) {
    ...
    $("#pin-sidebar").click(function () {
        if ($(".page-wrapper").hasClass("pinned")) {
            ...
            $(".navbar-brand img").removeClass("logo-hidden");
            $(this).find("i").removeClass("icon-toggled");
            $(".navbar-brand").removeClass("logo-disable");
        } else {
            // Pin sidebar
            ...
            $(".navbar-brand img").addClass("logo-hidden");
            $(this).find("i").addClass("icon-toggled");
            $(".navbar-brand").addClass("logo-disable");
        }
    });
